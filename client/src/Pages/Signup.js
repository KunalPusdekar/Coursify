...
const Signup = () => {
  ...
  const createNewAccount = async (event) => {
    ...
    try {
      ...
      // Check if response and payload are defined
    ...
    <Layout>
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
          ...
          {/* registration button */}
          <button
            className="w-full bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-lg hover:text-xl  py-2 font-semibold text-lg cursor-pointer"
            type="submit"
          >
            Create Account
          </button>
